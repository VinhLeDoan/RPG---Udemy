...
public class Clone_Skill : Skill
{
    ...
    public void CreateClone(Transform _clonePosition, Vector3 _offset)
    {
        ...
        newClone.GetComponent<Clone_Skill_Controller>()
            .SetupClone(_clonePosition, cloneDuration, canAttack, _offset, FindClosestEnemy(newClone.transform), canDuplicateClone, changeToDuplicate);
    }
    ...
    public void CreateCloneOnCounterAttack(Transform _enemyTranform)
    {
        if (canCreateCloneOnCounterAttack)
            StartCoroutine(CreateCloneWithDelay(_enemyTranform, new Vector3(1 * player.facingDir, 0)));
    }
