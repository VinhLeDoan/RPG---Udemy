...
public class Crystal_Skill : Skill
{
    ...
    public void CreateCrystal()
    {
        ...
        Crystal_Skill_Controller currenCystalScript = currentCrystal.GetComponent<Crystal_Skill_Controller>();

        currenCystalScript.SetupCrystal(crystalDuration, canExplode, canMoveToEnemy, moveSpeed, FindClosestEnemy(currentCrystal.transform));
